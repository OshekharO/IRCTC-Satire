  ...
  return (
    <div className={`flex flex-wrap items-center gap-2 ${className}`}>
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-sm font-semibold px-3 py-1.5 rounded-full transition-colors shadow-sm"
      >
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 bg-black hover:bg-gray-800 text-white text-sm font-semibold px-3 py-1.5 rounded-full transition-colors shadow-sm"
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 bg-[#1877F2] hover:bg-[#1465d3] text-white text-sm font-semibold px-3 py-1.5 rounded-full transition-colors shadow-sm"
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 bg-gray-200 hover:bg-gray-300 text-gray-700 text-sm font-semibold px-3 py-1.5 rounded-full transition-colors shadow-sm"
      >
        {copied ? (
          <>
